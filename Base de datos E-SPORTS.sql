...
-- BORRAMOS LAS POSIBLES TABLAS QUE EXISTIESEN EN EL SISTEMA PARA NO GENERAR ERRORES
DROP TABLE RANKING;
DROP TABLE PARTIDOS;
...
-- TABLA 'COMPETICIONES' QUE CONTIENE LOS DATOS DE LAS COMPETICIONES CON SU PREMIO Y MÁXIMO DE EQUIPOS
CREATE TABLE COMPETICIONES (
    COD_COMPETICION NUMBER(5) CONSTRAINT COM_COD_PK PRIMARY KEY,
    -- NO PUEDE HABER DOS COMPETICIONES CON EL MISMO NOMBRE
    NOMBRE_COMPETICION VARCHAR2(20) NOT NULL CONSTRAINT COM_NOM_UK UNIQUE,
    PREMIO NUMBER(5) CONSTRAINT COM_PRE_NN NOT NULL,
...
CREATE TABLE JUGADORES (
    ...
    -- NO PUEDE HABER DOS JUGADORES CON EL MISMO NICK
...
--------------------------------------------------------------------------------------------------------------------------------------------------
-- INSERTAMOS DATOS EN LAS TABLAS, SALVO 'PARTIDOS' Y 'RANKING' QUE SE GENERARÁN DE FORMA AUTOMÁTICA EN EL PROGRAMA
INSERT INTO COMPETICIONES VALUES (001, 'RPL MASTER RIFT', '500', 8);
